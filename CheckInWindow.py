...
class Ui_OutputDialog(QDialog):
    ...
    def face_rec_(self, frame, class_names):
        """
        ...
        if len(encodes_cur_frame) != 0:
            ...
            np.savetxt('tien_2.txt', encodes_cur_frame, delimiter='\n')
        dataset = open('tien_2.txt', mode='r')
        for encodeFace, faceLoc in zip(encodes_cur_frame, faces_cur_frame):
            match = face_recognition.compare_faces([np.loadtxt('tien_2.txt',  dtype=float, delimiter='\n', usecols=0)], encodeFace, tolerance=0.50)
            face_dis = face_recognition.face_distance([np.loadtxt('tien_2.txt',  dtype=float, delimiter='\n', usecols=0)], encodeFace)
    ...
    def update_frame(self):
        ...
        self.displayImage(self.image, self.class_names, 1)

    def displayImage(self, image, class_names, window=1):
        """
        ...
        try:
            image = self.face_rec_(image, class_names)
